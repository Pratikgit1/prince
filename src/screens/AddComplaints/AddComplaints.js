...
import { getCity, getProduct_type, getSub_type, getStateCityList,setSub_Type,
     addComplaintsSubmitData ,setBranchName,setProduct_Type,setSelectedState,setSelectedCity} from "../../store/actions/index";
...
class AddComplaints extends BaseComponent {
    state = {
    ...
    submitDataHandler = () => {
        const authData = {
            user_code: this.props.userData.username,
    ...
    render() {
        ...
        // if (this.props.selectedState.StateNm && this.state.controls.state.click) {
        //     this.setState(prevState => {
        //         return {
        //             controls: {
        //                 ...prevState.controls,
        //                 state: {
        //                     ...prevState.controls.state,
        //                     value: this.props.selectedState.StateCode,
        //                     click: true,
        //                 },
                        
        //                 city: {
        //                     ...prevState.controls.city,
        //                     value: this.props.selectedCity.Ct_Code,
        //                     click: true,
        //                 }
        ...
        return (
            <ScrollView contentContainerStyle={styles.container}>
                ...
                <View style={styles.detailContainer}>
                    ...
                    <Text style={[styles.textStyle, { marginTop: 10 }]}>Complaint details/summary</Text>
                    <DefaultInput
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        onSubmitData: (authData) => dispatch(addComplaintsSubmitData(authData, "admin")),
