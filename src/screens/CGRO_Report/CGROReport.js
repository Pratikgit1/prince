...
import {
    ...
    onForwardForwardTo, addCGROReeportSubmit,setCGROReportSearchData,setForwardLevel,setComplaint_source,setComplaint_type,
    setGrievance_cat,setPension_type,setRequest_cat,setBranch,setProduct_Type,setSub_Type
...
class CGROReport extends Component {
    state = {
        controls: {
                ...
                //   },
                  options: {
                      topBar: {
                          visible: true,
                          title: {
                              text: "CGROReportList", alignment: "center"
                          },
                      }
                  },
              },
...
export default connect(mapStateToProps, mapDispatchToProps)(CGROReport)