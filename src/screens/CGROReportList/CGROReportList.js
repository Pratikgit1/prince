...
class CGROReportList extends BaseComponent {
  ...
  offset:1
    ...
    constructor(props) {
      ...
      componentDidMount() {
        ...
        this.props.onSetListDataCGRO(this.props.cgro_report_search_data,complaints,this.state.offset)
      }
...
const mapDispatchToProps = dispatch => {
  return {
    onSetListDataCGRO: (authData,complaintsList,offset) => dispatch(addCGROReeportSubmit(authData,complaintsList,offset)),
    onsetComplaintsListData: (complaints) => dispatch(setCGROReportData(complaints)),
    onSendReport: (report) => dispatch(tyrSendCGROReport(report,"admin")),
...
export default connect(mapStateToProps, mapDispatchToProps)(CGROReportList);
