...
import { closeComplaintsFromHandler ,forwardComplaintsFromHandler,callForwardComplaintScreen} from "../../store/actions/index";
...
class ComplaintsDetails extends BaseComponent {
  ...
  showDocument = () => {
    ...
    ((this.props.complaintsDetails.document == null || this.props.complaintsDetails.document == "") ? "" : Navigation.push("DashBoard", {
      component: {
          id: 'WebView',
          name: 'orgs.WebView',
          passProps: {
  ...
  render() {
    ...
    console.log(this.props.titleData.title)
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    onCloseHandler: () => dispatch(closeComplaintsFromHandler()),
