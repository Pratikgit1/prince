...
import { userChangePassword, tyrOtp } from "../../store/actions/index";
...
class UserChangePassword extends Component {
    ...
    loginHandler = () => {
        const authData = {
            ...
            userCode: this.state.controls.userCode.value,
        };
        ...
        return (
            <ImageBackground source={backgroundImage} style={styles.backgroundImage}>
                ...
                <View
                    ...
                    <Text style={styles.textHeader}>User Change Password</Text>
                    <View style={styles.containerInput}>

                    <View style={styles.imageLayout}>
                            <Icon name="ios-mail" color="red" size={35} />
                            <Text style={styles.textTitle}>User Code</Text>

                        </View>
                        <DefaultInput
                            placeholder="User Code"
                            style={styles.input}
                            value={this.state.controls.userCode.value}
                            onChangeText={val => this.updateInputState("userCode", val)}
                            valid={this.state.controls.userCode.valid}
                            touched={this.state.controls.userCode.touched}
                                returnKeyType='next'
                                autoCapitalize='none'
                        />
                        <View style={styles.imageLayout}>
...
const mapDispatchToProps = dispatch => {
    return {
        onResetPassword: (authData) => dispatch(userChangePassword(authData)),
